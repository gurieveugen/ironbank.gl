			...
			<div id="header">
				...
				<div class="header-row">
					...
					<div class="header-area">
						<a href="http://www.asx.com.au/asx/research/companyInfo.do?by=asxCode&amp;asxCode=CZN" target="_blank"><img src="<?php echo TDU ?>/images/img-1.jpg" alt="image description"></a>
